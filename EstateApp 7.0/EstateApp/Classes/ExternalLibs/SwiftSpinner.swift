...
open class SwiftSpinner: UIView {
    ...
    public override init(frame: CGRect) {
        ...
        innerCircle.strokeEnd = 0.8
        innerCircle.lineCap = kCALineCapRound
        innerCircle.fillColor = UIColor.clear.cgColor
        innerCircle.strokeColor = UIColor(hex: "ffffff", alpha: 0.8).cgColor
    ...
    //
    open class func show(_ title: String) -> Void {
        _ = self.show(title, animated: true);
    }
    ...
    open var animating: Bool = false {
        ...
        didSet {
            ...
            if animating {
                ...
                self.innerCircle.strokeEnd = 0.8
            } else {
                self.outerCircle.strokeStart = 0.0
                self.outerCircle.strokeEnd = 0.0
                self.innerCircle.strokeStart = 0.0
    ...
    open func degreesToRadians(_ degrees: CGFloat) -> CGFloat {
    ...
    fileprivate func spinOuter() {
        ...
        self.outerCircleView.layer.add(animation, forKey: "circle")
    ...
    fileprivate func spinInner() {
        ...
        animation.timingFunction = CAMediaTimingFunction(name:kCAMediaTimingFunctionLinear)
        animation.repeatCount = HUGE
        self.innerCircleView.layer.add(animation, forKey: "inner_circle")
    }

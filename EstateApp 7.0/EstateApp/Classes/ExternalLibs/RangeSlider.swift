...
class RangeSlider: UIControl {
    ...
    var maximumValue: Double = 800000.0{
    ...
    var upperValue: Double = 800000.0 {
...
//        let widthDouble = Double(thumbWidth)
        ...
        let val = Double(bounds.width - thumbWidth) * (value - minimumValue)/(maximumValue - minimumValue) + Double(thumbWidth/2.0)
    ...
    override func continueTrackingWithTouch(touch: UITouch, withEvent event: UIEvent?) -> Bool {
        ...
        if lowerThumbLayer.highlighted {
            ...
            if (upperValue - deltaValue - lowerValue >= 49900) {
            ...
            if (upperValue + deltaValue - lowerValue > 50000) {
